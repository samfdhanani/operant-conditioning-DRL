...
datapath = os.path.normpath("/users/samdhanani/Desktop/MuhleLab/Operant_Data_Folders/CohortFolder")
IDList = [1, 2, 3, 4]
...
def data_construct(data):
    ...
    # Check if current value is between 1-2s or less than 1s
        if LA_array[i] >= 2 and LA_array[i] <= 3:         ######CHANGE 
